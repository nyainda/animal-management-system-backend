...
class UpdateTransactionRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            // Documentation
            'invoice_number' => 'nullable|string|max:255|unique:transactions,invoice_number,' . $this->route('transaction')->id,
            'contract_number' => 'nullable|string|max:255|unique:transactions,contract_number,' . $this->route('transaction')->id,
