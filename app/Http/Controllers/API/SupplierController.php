...
class SupplierController extends Controller
{
     ...
     *         required=true,
     *         @OA\JsonContent(
     *             @OA\Property(property="name", type="string", example="Farm Supplies Inc.", description="Supplier name"),
     *             @OA\Property(property="email", type="string", format="email", example="contact@farmsupplies.com", description="Supplier email"),
     *             @OA\Property(property="phone", type="string", example="+1234567890", description="Supplier phone"),
     *             @OA\Property(property="website", type="string", nullable=true, example="https://farmsupplies.com", description="Supplier website"),
     *             @OA\Property(property="tax_number", type="string", nullable=true, example="TAX123456", description="Tax number"),
     *             @OA\Property(property="address", type="string", example="123 Farm Road", description="Address"),
     *             @OA\Property(property="city", type="string", example="Springfield", description="City"),
     *             @OA\Property(property="state", type="string", example="IL", description="State"),
     ...
     *             @OA\Property(property="latitude", type="number", format="float", nullable=true, example=39.7817, description="Latitude"),
     *             @OA\Property(property="longitude", type="number", format="float", nullable=true, example=-89.6501, description="Longitude"),
     *             @OA\Property(property="type", type="string", example="vendor", description="Supplier type"),
     *             @OA\Property(property="product_type", type="string", example="feed", description="Product type"),
     *             @OA\Property(property="shop_name", type="string", nullable=true, example="Farm Store", description="Shop name"),
     ...
     *             @OA\Property(property="contract_start_date", type="string", format="date", nullable=true, example="2025-01-01", description="Contract start date"),
     *             @OA\Property(property="contract_end_date", type="string", format="date", nullable=true, example="2025-12-31", description="Contract end date"),
     *             @OA\Property(property="account_holder", type="string", nullable=true, example="Farm Supplies Inc.", description="Account holder"),
     *             @OA\Property(property="account_number", type="string", nullable=true, example="1234567890", description="Account number"),
     *             @OA\Property(property="bank_name", type="string", nullable=true, example="First National Bank", description="Bank name"),
     *             @OA\Property(property="bank_branch", type="string", nullable=true, example="Springfield Branch", description="Bank branch"),
     ...
     *             @OA\Property(property="supplier_importance", type="string", example="high", description="Supplier importance"),
     *             @OA\Property(property="inventory_level", type="integer", example=100, description="Inventory level"),
     *             @OA\Property(property="reorder_point", type="integer", example=20, description="Reorder point"),
     ...
     *             @OA\Property(property="notes", type="string", nullable=true, example="Reliable supplier", description="Notes"),
     *             @OA\Property(property="contact_name", type="string", example="Jane Doe", description="Primary contact name"),
     *             @OA\Property(property="contact_position", type="string", nullable=true, example="Sales Manager", description="Primary contact position"),
     *             @OA\Property(property="contact_email", type="string", format="email", nullable=true, example="jane@farmsupplies.com", description="Primary contact email"),
     *             @OA\Property(property="contact_phone", type="string", nullable=true, example="+1234567891", description="Primary contact phone"),
     *             @OA\Property(
     *                 property="additional_contacts",
     *                 type="array",
     *                 nullable=true,
     *                 description="Additional supplier contacts",
     *                 @OA\Items(
     *                     type="object",
     *                     @OA\Property(property="name", type="string", example="John Smith", description="Contact name"),
     *                     @OA\Property(property="position", type="string", nullable=true, example="Assistant Manager", description="Contact position"),
     *                     @OA\Property(property="email", type="string", format="email", nullable=true, example="john@farmsupplies.com", description="Contact email"),
     *                     @OA\Property(property="phone", type="string", nullable=true, example="+1234567892", description="Contact phone")
     *                 )
     *             ),
     *             @OA\Property(property="relationship_type", type="string", example="primary", description="Type of relationship with the animal"),
     *             @OA\Property(property="start_date", type="string", format="date", nullable=true, example="2025-01-01", description="Relationship start date"),
     *             @OA\Property(property="end_date", type="string", format="date", nullable=true, example="2025-12-31", description="Relationship end date"),
     *             @OA\Property(property="relationship_notes", type="string", nullable=true, example="Main feed supplier", description="Notes about the relationship")
     *         )
     *     ),
     *     @OA\Response(
     *         response=201,
