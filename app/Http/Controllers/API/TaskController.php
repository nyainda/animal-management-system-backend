...
class TaskController extends Controller
{
     ...
     *             @OA\Property(property="task_type", type="string", example="health_check"),
     *             @OA\Property(property="start_date", type="string", example="2025-03-15"),
     *             @OA\Property(property="start_time", type="string", example="14:30"),
     *             @OA\Property(property="end_date", type="string", example="2025-03-15"),
     *             @OA\Property(property="end_time", type="string", example="15:30"),
     *             @OA\Property(property="duration", type="integer", example=60),
     *             @OA\Property(property="description", type="string", example="Discuss project progress and next steps"),
     *             @OA\Property(property="health_notes", type="string", example="Remember to take a break afterward"),
     ...
     *             @OA\Property(property="repeats", type="string", example="weekly"),
     *             @OA\Property(property="repeat_frequency", type="integer", example=1),
     *             @OA\Property(property="end_repeat_date", type="string", example="2025-04-30")
     *         )
     *     ),
     *     @OA\Response(
     *         response=201,
